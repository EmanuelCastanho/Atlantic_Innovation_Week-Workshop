...
- Create an environment called AIW-Workshop-Env, install Jupyter Notebook and open the workshop notebook, then run the cell that installs the required packages.
