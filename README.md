...
To run this workshop just click on the **Binder Environment**. If you want to test the *sentinelsat* library, you will need a [Copernicus Open Access Hub](https://scihub.copernicus.eu/dhus/#/self-registration) free account. This is not mandatory as the Sentinel-2 product is already downloaded.
